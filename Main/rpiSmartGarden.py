...
def soil_moisture_out_of_range_check():
...
def water_tank_level_percentage_calculation():
...
def soil_moisture_level_percentage_calculation():
...
def send_data_to_database():
    ...
    val = (final_soil_moisture, final_temperature, final_humidity, final_light_level, final_water_tank_level,
           final_water_usage)
...
while True:
    try:
        ...
        temperature_raw_input = read_temperature()

        # DHT22 humidity sensor
        humidity_raw_input = read_humidity()

        # Ultrasonic water tank sensor
        water_tank_level_raw_input = read_water_tank_level()

        # Capacitive soil moisture sensor
        soil_moisture_raw_input = read_soil_moisture_level()

        # Light sensor
        light_rounded = read_light_level()

        print("Success")

        #print(temperature_raw_input)
        #print(humidity_raw_input)
        #print(water_tank_level_raw_input)
        #print(soil_moisture_raw_input)
        #print(light_rounded)

        # Soil moisture out of range failure check
        print("\n== Raw input data out of range check... ==")
        soil_moisture_out_of_range_check()

        print("\n== Processing sensor data into a user readable format... ==")
        # Water tank level percentage calculation
        water_tank_level_percentage = water_tank_level_percentage_calculation()

        # Soil moisture percentage calculation
        soil_moisture_level_percentage = soil_moisture_level_percentage_calculation()

        # Assign variables
        final_soil_moisture = soil_moisture_level_percentage
